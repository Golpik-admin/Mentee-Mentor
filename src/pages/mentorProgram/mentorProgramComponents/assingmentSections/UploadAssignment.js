...
//   // Handle file upload  Apis integration
...
//   // Simulate file upload without backend
//   const handleFileUpload = async (event) => {
//     event.preventDefault();
...
const UploadAssignmentModal = ({ isOpen, closePopup, onUpload }) => {
  ...
  return (
    <div className="pt-2">
      {/* Render uploaded details if showDetails is true */}
      {showDetails && (
        <div className="border shadow w-full h-full mt-4">
          <div className="bg-[#F5F5F5] p-4 flex justify-between w-[100%] flex-row items-center">
            <h1 className="w-[20%] text-center text-colorSecondary text-sm font-semibold">
              Assignment Title
            </h1>
